    ...
    <div className="min-h-screen bg-[#0a0a0b] text-white selection:bg-indigo-500/30">
      ...
      <nav className="fixed top-0 w-full z-50 border-b border-white/5 bg-[#0a0a0b]/80 backdrop-blur-xl">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xl font-bold tracking-tight">Saby</span>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
          ...
          >
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 text-xs font-medium text-indigo-400 mb-8">
              ...
              <span>La nueva era de las plataformas para comunidades</span>
            </div>
            <h1 className="text-6xl md:text-8xl font-black tracking-tight mb-8 bg-gradient-to-b from-white to-zinc-500 bg-clip-text text-transparent">
              Crea tu propia Tribu <br /> en un espacio premium.
            </h1>
            <p className="max-w-2xl mx-auto text-lg md:text-xl text-zinc-400 leading-relaxed mb-12">
              Lleva tu comunidad y tus formaciones al siguiente nivel con Saby. Un ecosistema impulsado por IA con un diseño exquisito y automatizaciones de vanguardia.
            </p>
      ...
      <section className="py-32 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            <h2 className="text-4xl font-bold mb-4">Construido para crecer, diseñado para deslumbrar.</h2>
            <p className="text-zinc-400">Saby se encarga de la mecánica técnica para que tú puedas centrarte en tu Tribu.</p>
          </div>

          <div className="grid md:grid-cols-3 gap-8">
            <FeatureCard
              icon={<Users className="w-6 h-6" />}
              title="Tribus Globales"
              description="Gestiona a miles de miembros de tu tribu con facilidad. Incluye herramientas avanzadas de moderación."
            />
            <FeatureCard
              icon={<GraduationCap className="w-6 h-6" />}
              title="Aulas Inteligentes"
              description="Crea test automáticos con Inteligencia Artificial a partir de tus vídeos y puntúa a tu tribu en tiempo real."
            />
            <FeatureCard
              icon={<Shield className="w-6 h-6" />}
              title="Privacidad Premium"
              description="Protección de nivel empresarial para el contenido hiper exclusivo de los miembros de tu tribu."
            />
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-6">
        <div className="max-w-5xl mx-auto bg-gradient-to-br from-indigo-600 to-violet-700 rounded-[40px] p-12 md:p-20 text-center relative overflow-hidden shadow-2xl shadow-indigo-500/20">
          ...
          <h2 className="text-4xl md:text-5xl font-black mb-8">¿Listo para evolucionar con tu propia Tribu?</h2>
      ...
      <footer className="py-20 px-6 border-t border-white/5">
        <div className="max-w-7xl mx-auto flex flex-col md:row items-center justify-between gap-8">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold">Saby</span>
          </div>
          <div className="text-zinc-500 text-sm">
            © 2026 Saby. Todos los derechos premium reservados.
          </div>
        </div>
      </footer>
    </div>
